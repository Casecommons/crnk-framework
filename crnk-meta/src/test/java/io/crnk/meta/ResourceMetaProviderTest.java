...
public class ResourceMetaProviderTest extends AbstractMetaTest {
	...
	public void testInheritanceOnResource() {
		...
		MetaKey primaryKey = meta.getPrimaryKey();
		Assertions.assertNotNull(primaryKey.getName(), "id");
	...
	public void testSingleValuedRelation() {
		...
		Assertions.assertNotNull(attr.getOppositeAttribute().getName(), "tasks");
	...
	public void testMultiValuedSetRelation() {
		...
		Assertions.assertNotNull(attr.getOppositeAttribute().getName(), "taskSet");
