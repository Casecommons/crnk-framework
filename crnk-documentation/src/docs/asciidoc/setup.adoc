...
dependencies {
	...
	compile 'io.crnk:crnk-setup-spring-boot4'
	...
}
----
...
- `io.crnk:crnk-setup-spring-boot4` support for Spring Boot 4.x.

There is a `CrnkCoreAutoConfiguration` in `crnk-setup-spring-boot4` that outlines
...
`io.crnk:crnk-setup-spring-boot4` hosts Spring Boot auto configurations
...
See https://github.com/crnk-project/crnk-framework/blob/master/crnk-setup/crnk-setup-spring-boot4/src/main/java/io/crnk/setup/spring/boot/core/CrnkCoreProperties.java[CrnkCoreProperties]
