...
public class QuerySpecTest {
    ...
    public void testBasic() {
        ...
        Assert.assertEquals(filterSpec, spec.findFilter(PathSpec.of("filterAttr")).get());
        ...
        Assert.assertEquals(0, spec.getNestedSpecs().size());
        ...
        Assert.assertEquals(1, spec.getNestedSpecs().size());
    ...
    public void testClone() {
        ...
        Assert.assertNotSame(spec.getPaging(), duplicate.getPaging());
